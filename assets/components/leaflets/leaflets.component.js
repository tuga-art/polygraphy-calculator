(function () {
  ...
  angular
    ...
    .component('leafletsElem', {
      templateUrl: 'wp-content/plugins/rg-polygraphy-calculator/assets/components/leaflets/leaflets.tmpl.html',
      controller: 'leafletsController',
    });


    leafletsController.$inject = ['$scope', '$timeout', 'dataService', 'calcService'];

    function leafletsController($scope, $timeout, dataService, calcService) {
      var sc = $scope;

      sc.prodAttr = dataService.production.leaflets;
      ...
      function calculateFinalPrice(sel) {
        ...
        var result = (printing+sel.material.cost+varData)*amount;
